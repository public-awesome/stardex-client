...
export interface StardexTokenReadOnlyInterface {
...
export declare class StardexTokenQueryClient implements StardexTokenReadOnlyInterface {
...
export interface StardexTokenInterface extends StardexTokenReadOnlyInterface {
    contractAddress: string;
    sender: string;
...
export declare class StardexTokenClient extends StardexTokenQueryClient implements StardexTokenInterface {
